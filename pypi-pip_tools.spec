...
Source0  : https://files.pythonhosted.org/packages/cc/1c/dadd465f327dbe49d77d8d3bcd651607d3169a04ce06c7bf86fec8005425/pip-tools-6.9.0.tar.gz
...
%prep
%setup -q -n pip-tools-6.9.0
cd %{_builddir}/pip-tools-6.9.0
pushd ..
cp -a pip-tools-6.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666742092
